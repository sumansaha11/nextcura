...
const DoctorAppointments = () => {
  ...
  const { dToken, getDoctorInfo, appointments, getAppointments, completeAppointment, cancelAppointment } = useContext(DoctorContext);
  ...
  return (
    <div className='w-full max-w-6xl m-5'>
      ...
      <div className='bg-white border rounded text-sm min-h-[50vh] max-h-[75vh] overflow-y-scroll'>
